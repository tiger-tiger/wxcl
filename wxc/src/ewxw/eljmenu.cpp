...
EWXWEXPORT(wxString*, wxMenu_GetLabel)(wxMenu* _obj, int id)
{
...
EWXWEXPORT(wxString*, wxMenu_GetHelpString)(wxMenu* _obj, int id)
{
...
EWXWEXPORT(wxString*, wxMenu_GetTitle)(wxMenu* _obj)
{
