...
(defmethod bitmap-disabled ((obj bitmap-button))
    ...
    (make-wx-instance 'bitmap (wxBitmapButton_GetBitmapDisabled (object-pointer obj))))
...
(defmethod bitmap-focus ((obj bitmap-button))
    "Returns the bitmap for the focused state."
     (make-wx-instance 'bitmap (wxBitmapButton_GetBitmapFocus (object-pointer obj))))
...
(defmethod bitmap-label ((obj bitmap-button))
    ...
    (make-wx-instance 'bitmap (wxBitmapButton_GetBitmapLabel (object-pointer obj))))
...
(defmethod bitmap-selected ((obj bitmap-button))
    ...
    (make-wx-instance 'bitmap (wxBitmapButton_GetBitmapSelected (object-pointer obj))))
